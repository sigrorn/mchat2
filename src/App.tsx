  ...
  if (!bootCache) {
    bootCache = (async () => {
      ...
      try {
        ...
        await getCurrentWindow().setTitle(`mchat2 v${__BUILD_INFO__.timestamp} (${__BUILD_INFO__.commitHash})`);
      } catch {
        document.title = `mchat2 v${__BUILD_INFO__.timestamp} (${__BUILD_INFO__.commitHash})`;
      }
    })();
  }
  return bootCache;
